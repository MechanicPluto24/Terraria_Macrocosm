...
{
    public abstract class RegolithRockLarge : ModTile
    {
        // We want both tiles to use the same texture
        public override string Texture => this.GetNamespacePath().Replace(Name, nameof(RegolithRockLarge));
    ...
    public class RegolithRockLargeNatural : RegolithRockLarge
    {
        public override void SetStaticDefaults()
        {
    ...
    public class RegolithRockLargeFake : RegolithRockLarge
    {
        public override void SetStaticDefaults()
        {
            ...
            FlexibleTileWand.RubblePlacementLarge.AddVariations(ModContent.ItemType<Regolith>(), Type, 0..4);
