...
{
    public abstract class RegolithRockSmall : ModTile
    {
        // We want both tiles to use the same texture
        public override string Texture => this.GetNamespacePath().Replace(Name, nameof(RegolithRockSmall));
    ...
    public class RegolithRockSmallNatural : RegolithRockSmall
    {
        public override void SetStaticDefaults()
        {
    ...
    public class RegolithRockSmallFake : RegolithRockSmall
    {
        public override void SetStaticDefaults()
        {
