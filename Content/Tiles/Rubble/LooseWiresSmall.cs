...
{
    public abstract class LooseWiresSmall : ModTile
    {
        // We want both tiles to use the same texture
        public override string Texture => this.GetNamespacePath().Replace(Name, nameof(LooseWiresSmall));
    ...
    public class LooseWiresSmallNatural : LooseWiresSmall
    {
        public override void SetStaticDefaults()
        {
    ...
    public class LooseWiresSmallFake : LooseWiresSmall
    {
        public override void SetStaticDefaults()
        {
