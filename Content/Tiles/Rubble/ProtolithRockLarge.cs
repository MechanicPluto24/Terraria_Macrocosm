...
{
    public abstract class ProtolithRockLarge : ModTile
    {
        // We want both tiles to use the same texture
        public override string Texture => this.GetNamespacePath().Replace(Name, nameof(ProtolithRockLarge));
    ...
    public class ProtolithRockLargeNatural : ProtolithRockLarge
    {
        public override void SetStaticDefaults()
        {
    ...
    public class ProtolithRockLargeFake : ProtolithRockLarge
    {
        public override void SetStaticDefaults()
        {
