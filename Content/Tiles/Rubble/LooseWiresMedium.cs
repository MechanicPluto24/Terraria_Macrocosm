...
{
    public abstract class LooseWiresMedium : ModTile
    {
        // We want both tiles to use the same texture
        public override string Texture => this.GetNamespacePath().Replace(Name, nameof(LooseWiresMedium));
    ...
    public class LooseWiresMediumNatural : LooseWiresMedium
    {
        public override void SetStaticDefaults()
        {
    ...
    public class LooseWiresMediumFake : LooseWiresMedium
    {
        public override void SetStaticDefaults()
        {
