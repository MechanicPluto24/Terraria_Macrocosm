...
{
    public abstract class ProtolithRockMedium : ModTile
    {
        // We want both tiles to use the same texture
        public override string Texture => this.GetNamespacePath().Replace(Name, nameof(ProtolithRockMedium));
    ...
    public class ProtolithRockMediumNatural : ProtolithRockMedium
    {
        public override void SetStaticDefaults()
        {
    ...
    public class ProtolithRockMediumFake : ProtolithRockMedium
    {
        public override void SetStaticDefaults()
        {
