...
{
    public abstract class LooseWiresLargeBase : ModTile
    {
        // We want both tiles to use the same texture
        public override string Texture => "Macrocosm/Content/Tiles/Ambient/LooseWiresLarge";
    ...
    public class LooseWiresLargeFake : LooseWiresLargeBase
    {
        public override void SetStaticDefaults()
        {
    ...
    public class LooseWiresLargeNatural : LooseWiresLargeBase
    {
        public override void SetStaticDefaults()
        {
            base.SetStaticDefaults();
