...
{
    public abstract class LooseWiresSmallBase : ModTile
    {
        // We want both tiles to use the same texture
        public override string Texture => "Macrocosm/Content/Tiles/Ambient/LooseWiresSmall";
    ...
    public class LooseWiresSmallFake : LooseWiresSmallBase
    {
        public override void SetStaticDefaults()
        {
            ...
            FlexibleTileWand.RubblePlacementSmall.AddVariations(ItemID.Wire, Type, 0, 1);
    ...
    public class LooseWiresSmallNatural : LooseWiresSmallBase
    {
        public override void SetStaticDefaults()
        {
            base.SetStaticDefaults();
