...
public class RegolithChest : ModTile
{
    public override void SetStaticDefaults()
    {
        ...
        AddMapEntry(new(201, 201, 204), CreateMapEntryName(), MapChestName);

        RegisterItemDrop(ModContent.ItemType<Items.Furniture.Regolith.RegolithChest>(), 0, 1);
