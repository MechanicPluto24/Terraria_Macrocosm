    ...
    public class LuminiteLamp : ModTile, IToggleableTile
    {
        ...
        public override void SetStaticDefaults()
        {
            ...
            foreach (LuminiteStyle style in Enum.GetValues(typeof(LuminiteStyle)))
                AddMapEntry(Utility.GetTileColorFromLuminiteStyle(style), Language.GetText("ItemName.Lamp"));
        ...
        {
            Tile tile = Main.tile[i, j];
            Color color = Utility.GetLightColorFromLuminiteStyle((LuminiteStyle)(Main.tile[i, j].TileFrameY / (18 * 3)));
