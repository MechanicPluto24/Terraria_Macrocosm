...
{
    public class MoonBaseDeskClock : ModTile
    {
        ...
        public override void SetStaticDefaults()
        {
            ...
            RegisterItemDrop(ModContent.ItemType<Items.Furniture.MoonBase.MoonBaseDeskClock>(), 0, 1);
        }
        ...
        public override void MouseOver(int i, int j)
        {
            if(Main.tile[i, j].TileFrameY >= 18)
            {
                ...
                player.cursorItemIconID = ModContent.ItemType<Items.Furniture.MoonBase.MoonBaseDeskClock>();
            }
        }
