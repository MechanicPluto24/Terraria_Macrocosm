...
namespace Macrocosm.Content.Items.Weapons.Magic
{
    public class CelestialMeteorStaff : ModItem
    {
        ...
        public int getMeteorType()
        {
            ...
            {
                case 0:
                    return ModContent.ProjectileType<CelestialMeteorStaffProjectileSolar>();
                    break;
                case 1:
                    return ModContent.ProjectileType<CelestialMeteorStaffProjectileVortex>();
                    break;
                case 2:
                    return ModContent.ProjectileType<CelestialMeteorStaffProjectileNebula>();
                    break;
                case 3:
                    return ModContent.ProjectileType<CelestialMeteorStaffProjectileStardust>();
                    break;
            }
            return 0;
        }
