...
{
    public class PhantasmalPortalSmall : PhantasmalPortal
    {
        ...
        {
            defWidth = defHeight = Projectile.width = Projectile.height = 50;
            ...
            else
            {
                ...
                if (Projectile.timeLeft % SpawnPeriod == 0)
                {
                    if (Main.netMode != NetmodeID.MultiplayerClient)
                    {
                        ...
                        Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center, velocity, ModContent.ProjectileType<PhantasmalImpSmall>(),
