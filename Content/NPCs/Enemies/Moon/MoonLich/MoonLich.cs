...
using Macrocosm.Content.NPCs.Enemies.Moon.MoonLich;
...
{
    public class MoonLich : ModNPC, IMoonEnemy
    {
        ...
        offestY=(float)(Math.Sin(Timer/10)*7);
        Timer++;
        if (Timer%5==0)
        ...
        Vector2 drawPos = (NPC.Center+new Vector2(35f,50f+offestY))-Main.screenPosition;
        ...
        Vector2 drawPos2 = (NPC.Center+new Vector2(-35f,50f+offestY))-Main.screenPosition;
        //left
