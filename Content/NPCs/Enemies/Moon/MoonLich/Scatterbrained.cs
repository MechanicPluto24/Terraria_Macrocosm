...
namespace Macrocosm.Content.NPCs.Enemies.Moon.MoonLich
{
    public class Scatterbrained : ModNPC
    {
        ...
        private const int maxCooldown = 120;
        ...
        private void AI_Shoot()
        {
            ...
            int projDamage = Utility.TrueDamage((int)(NPC.damage * 1.2));
            int projType = ModContent.ProjectileType<GreenLaser>();
            float projSpeed = 120;
        ...
        {
            /* Worry about this when we have an actual sprite
