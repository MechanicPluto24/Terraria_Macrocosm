...
public class AutosmelterT3 : MachineTile
{
    public override short Width => 5;
    public override short Height => 4;
    public override MachineTE MachineTE => ModContent.GetInstance<AutosmelterT3TE>();
    ...
    public override void ModifyLight(int i, int j, ref float r, ref float g, ref float b)
    {
        ...
        if (tileOffsetX is 1 or 2 or 3 && tileOffsetY is 2)
        {
            if (IsPoweredOnFrame(i, j))
                tile.GetEmmitedLight(new Color(154, 248, 224), applyPaint: false, out r, out g, out b);
        }
    }
}
