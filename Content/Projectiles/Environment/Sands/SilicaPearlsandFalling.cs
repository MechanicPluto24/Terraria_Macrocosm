...
namespace Macrocosm.Content.Projectiles.Environment.Sands
{
    public class SilicaPearlsandFalling : ModProjectile
    {
        ...
        public override void SetStaticDefaults()
        {
            ...
            ProjectileID.Sets.FallingBlockTileItem[Type] = new(ModContent.TileType<Tiles.Blocks.SilicaPearlsand>(), ModContent.ItemType<Items.Placeable.Blocks.SilicaPearlsand>());
        }
