...
{
    public class PurpleEnergyBolt : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            Timer++;
            Lighting.AddLight(Projectile.Center, new Color(255, 0, 255).ToVector3());
        }
        ...
        public override void OnKill(int timeLeft)
        {
            ...
            for (int i = 0; i < Projectile.oldPos.Length; i++)
            {
                for (int j = 0; j < 3; j++)
                {
                    ...
                    Dust dust = Dust.NewDustDirect(pos, 20, 20, DustID.PurpleTorch, 0f, Projectile.oldVelocity.Y * 0.5f, Scale: Main.rand.NextFloat(1f, 1.6f) * (1f - progress), Alpha: 0, newColor: new Color(255, 0, 255, 0));
                    dust.noGravity = true;
                }
            }
        }
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            Main.EntitySpriteDraw(texture, Projectile.Center - Main.screenPosition, null, new Color(255, 150, 255, 0), Projectile.velocity.ToRotation() + MathHelper.PiOver2, texture.Size() / 2f, Projectile.scale * 0.35f, SpriteEffects.None, 0f);
            return false;
        }
    }
