...
namespace Macrocosm.Content.Projectiles.Friendly.Magic.WaveGuns
{
    public class WaveGunBlueBolt : ModProjectile
    {
        ...
        protected WaveGunBeamTrail trail;
        ...
        public override void AI()
        {
            if (!spawned)
            {
                ...
                trail = new WaveGunBeamTrail(BeamColor * 0.8f);
            ...
            if (Projectile.numUpdates % 2 == 0)
                Projectile.UpdateTrail(smoothAmount: skipTrailUpdate ? 0f : 0.65f);
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            for (int n = 0; n < 4; n++)
            {
                ...
                for (int i = 1; i < positions.Length; i++)
                {
                    ...
                    positions[i] += Main.rand.NextVector2Unit() * Main.rand.NextFloat((6f + n * 2)  * Utility.InverseLerp(0, 120, AI_Timer, clamped: true));
                }
