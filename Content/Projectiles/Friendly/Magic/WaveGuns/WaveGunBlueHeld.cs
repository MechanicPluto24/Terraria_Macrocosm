...
namespace Macrocosm.Content.Projectiles.Friendly.Magic.WaveGuns
{
    ...
    {
        public override string Texture => ModContent.GetInstance<WaveGunBlue>().Texture;
        ...
        public override void ProjectileAI()
        {
            ...
            if (Player.whoAmI == Main.myPlayer)
            {
                ...
                if (AI_Timer % AI_FireRate == 0)
                {
                    ...
                    Projectile.NewProjectile(Projectile.GetSource_FromAI(), position, velocity, ModContent.ProjectileType<WaveGunBlueBolt>(), damage, knockback, Projectile.owner);
