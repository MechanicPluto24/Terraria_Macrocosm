    ...
    public class RapaciousBrandSwing : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (Main.rand.NextFloat() * 2f < Projectile.Opacity)
            {
                ...
                Dust coloredDust = Dust.NewDustPerfect(Projectile.Center + dustRotation.ToRotationVector2() * (Main.rand.NextFloat() * 80f * Projectile.scale + 20f * Projectile.scale), DustID.Blood, dustVelocity * 1f, 100, dustColor, 0.4f);
            ...
            if (Main.rand.NextFloat() * 1.5f < Projectile.Opacity)
            {
                ...
                Dust.NewDustPerfect(dustPosition, DustID.Blood, dustVelocity, 100, Color.White * Projectile.Opacity, 1.2f * Projectile.Opacity);
            }
        ...
        {
            Dust.NewDust(Main.rand.NextVector2FromRectangle(target.Hitbox), 0, 0, DustID.Blood);
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            Color color = new Color(208, 60, 86);
