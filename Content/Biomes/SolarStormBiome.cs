...
public class SolarStormBiome : ModBiome
{
    public override SceneEffectPriority Priority => SceneEffectPriority.Event;

    //public override string BestiaryIcon => Macrocosm.TexturesPath + "Icons/SolarStorm";
    ...
    //public override int Music => MusicLoader.GetMusicSlot(Mod, "Assets/Music/SolarStormTheme");

    public override void SetStaticDefaults()
    {
    }

    public override bool IsBiomeActive(Player player) => SubworldSystem.IsActive<Moon>() && WorldData.Current.SolarStorm;
