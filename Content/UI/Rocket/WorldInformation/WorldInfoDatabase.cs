...
namespace Macrocosm.Content.UI.Rocket.WorldInformation
{
    public class WorldInfoDatabase : ILoadable
    {
		...
		// database.Add("Name", new WorldInfo("Name", new()
		//	{
		//		
		//	}));
		private static void PopulateDatabase()
        {
			...
			database.Add("Sun", new WorldInfo("Sun", new()
            {
                ...
                new WorldInfoElement(ThreatLevel.Apollyon)
            }));
			...
			database.Add("Earth", new WorldInfo("Earth", new()
			{
				...
				new WorldInfoElement(ThreatLevel.Harmless)
			...
			database.Add("Moon", new WorldInfo("Moon", new()
			{
				...
				new WorldInfoElement(ThreatLevel.Arduous),

				new WorldInfoElement("MeteorStorms", InfoType.Hazard),
				new WorldInfoElement("SolarStorms", InfoType.Hazard)
			}));
