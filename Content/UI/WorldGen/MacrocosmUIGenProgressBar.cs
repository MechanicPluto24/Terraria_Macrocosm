...
namespace Macrocosm.Content.UI.WorldGen
{
	public class MacrocosmUIGenProgressBar : UIGenProgressBar
	{
		...
		public MacrocosmUIGenProgressBar(Texture2D texUpper, Texture2D texLower)
		{
			if (Main.netMode != NetmodeID.Server)
			{
				...
				fillLarge = ModContent.Request<Texture2D>("Macrocosm/Content/UI/WorldGen/DefaultLargeFill", AssetRequestMode.ImmediateLoad).Value;
				fillSmall = ModContent.Request<Texture2D>("Macrocosm/Content/UI/WorldGen/DefaultSmallFill", AssetRequestMode.ImmediateLoad).Value;
			}
			base.Recalculate();
		}

		public MacrocosmUIGenProgressBar(Texture2D texUpper, Texture2D texLower, Color fillLargeStart, Color fillLargeEnd, Color fillSmallStart, Color fillSmallEnd) : this(texUpper, texLower)
		{
		...
		public MacrocosmUIGenProgressBar(Texture2D texUpper, Texture2D texLower, Texture2D fillLarge, Texture2D fillSmall) : this(texUpper, texLower)
		{
			if (Main.netMode != NetmodeID.Server)
			{
		...
		public MacrocosmUIGenProgressBar(Texture2D texUpper, Texture2D texLower, Texture2D fillLarge, Texture2D fillSmall, Color fillLargeStart, Color fillLargeEnd, Color fillSmallStart, Color fillSmallEnd) : this(texUpper, texLower, fillLarge, fillSmall)
		{
			this.fillLargeStart = fillLargeStart;
			this.fillLargeEnd = fillLargeEnd;
			this.fillSmallStart = fillSmallStart;
