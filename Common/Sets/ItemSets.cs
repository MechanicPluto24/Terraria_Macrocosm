...
namespace Macrocosm.Common.Sets
{
    ...
    public class ItemSets
    {
        ...
        public static FuelData[] FuelData { get; } = ItemID.Sets.Factory.CreateCustomSet(defaultState: new FuelData(),
            ...
            ItemID.LivingWoodPlatform, new FuelData(FuelPotency.VeryLow, 80),
            ItemID.LivingWoodChair, new FuelData(FuelPotency.VeryLow, 80),
            ItemID.LivingWoodDoor, new FuelData(FuelPotency.VeryLow, 80),
            ItemID.LivingWoodTable, new FuelData(FuelPotency.VeryLow, 80),
            ItemID.LivingWoodSink, new FuelData(FuelPotency.VeryLow, 80),
            ItemID.LivingWoodBed, new FuelData(FuelPotency.VeryLow, 80),
            ItemID.LivingWoodBookcase, new FuelData(FuelPotency.VeryLow, 80),
            ItemID.LivingWoodDresser, new FuelData(FuelPotency.VeryLow, 80),
            ItemID.LivingWoodClock, new FuelData(FuelPotency.VeryLow, 80),
            ItemID.LivingWoodPiano, new FuelData(FuelPotency.VeryLow, 80),
            ItemID.LivingWoodSofa, new FuelData(FuelPotency.VeryLow, 80),
            ItemID.LivingWoodChest, new FuelData(FuelPotency.VeryLow, 80),

            ItemID.AshWoodPlatform, new FuelData(FuelPotency.Low, 80),
            ItemID.AshWoodChair, new FuelData(FuelPotency.Low, 80),
            ItemID.AshWoodDoor, new FuelData(FuelPotency.Low, 80),
            ItemID.AshWoodTable, new FuelData(FuelPotency.Low, 80),
            ItemID.AshWoodSink, new FuelData(FuelPotency.Low, 80),
            ItemID.AshWoodBed, new FuelData(FuelPotency.Low, 80),
            ItemID.AshWoodBookcase, new FuelData(FuelPotency.Low, 80),
            ItemID.AshWoodDresser, new FuelData(FuelPotency.Low, 80),
            ItemID.AshWoodClock, new FuelData(FuelPotency.Low, 80),
            ItemID.AshWoodPiano, new FuelData(FuelPotency.Low, 80),
            ItemID.AshWoodSofa, new FuelData(FuelPotency.Low, 80),
            ItemID.AshWoodChest, new FuelData(FuelPotency.Low, 80),
            // TODO continue...
