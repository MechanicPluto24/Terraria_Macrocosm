	...
	public class MacrocosmUIGenProgressBar : UIGenProgressBar
	{
		...
		public MacrocosmUIGenProgressBar(Texture2D texUpper, Texture2D texLower)
		{
			if (Main.netMode != NetmodeID.Server)
			{
				...
				fillLarge = ModContent.Request<Texture2D>("Macrocosm/Assets/Textures/UI/WorldGen/DefaultLargeFill", AssetRequestMode.ImmediateLoad).Value;
				fillSmall = ModContent.Request<Texture2D>("Macrocosm/Assets/Textures/UI/WorldGen/DefaultSmallFill", AssetRequestMode.ImmediateLoad).Value;
			}
			base.Recalculate();
		}
