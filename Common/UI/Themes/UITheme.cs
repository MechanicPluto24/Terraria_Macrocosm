...
namespace Macrocosm.Common.UI.Themes
{
    ...
    public readonly partial struct UITheme
    {
        ...
        public UIPanelStyle TabStyle { get; init; } = new UIPanelStyle(Color.Transparent, Color.Transparent);
        ...
        public UIPanelStyle ButtonStyle { get; init; } = new UIPanelStyle(new Color(73, 85, 186), Color.Black);
        public UIPanelStyle ButtonHighlightStyle { get; init; } = new UIPanelStyle(new Color(69, 90, 166), Color.Gold);
