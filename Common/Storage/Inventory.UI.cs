...
namespace Macrocosm.Common.Storage
{
    public partial class Inventory
    {
        ...
        private UIListScrollablePanel CreateInventorySlotsList(int iconsPerRow = 10, int rowsWithoutScrollbar = 5, float iconSize = 48f)
        {
            ...
            {
                UICustomItemSlot uiItemSlot = CreateItemSlot(i, ItemSlot.Context.ChestItem);
        ...
        private UICustomItemSlot CreateItemSlot(int index, int itemSlotContext = ItemSlot.Context.ChestItem, float scale = default)
        {
